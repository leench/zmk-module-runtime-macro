...
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_VERSION 2U
#if defined(CONFIG_ZMK_RUNTIME_MACRO_DYNAMIC_SLOT_COUNT)
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_OBJECT_COUNT \
  CONFIG_ZMK_RUNTIME_MACRO_DYNAMIC_SLOT_COUNT
#else
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_OBJECT_COUNT 8U
#endif
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_PAYLOAD_LENGTH 22U
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_BOOT (1U << 0)
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_TTL_EXPIRY (1U << 1)
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_EXECUTION_ACCEPT \
  (1U << 2)
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_USB_DISCONNECT (1U << 3)
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_BLE_PROFILE_CHANGE \
  (1U << 4)
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_ENDPOINT_CHANGE \
  (1U << 5)
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_SUPPORTS_KEEP_AFTER_EXECUTE \
  (1U << 6)
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_FIXED_LIFECYCLE_FLAGS \
  (ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_BOOT | \
   ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_TTL_EXPIRY | \
   ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_EXECUTION_ACCEPT)
...
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_USB_DISCONNECT_FLAG \
  ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_USB_DISCONNECT
#else
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_USB_DISCONNECT_FLAG 0U
#endif

#if defined(CONFIG_ZMK_BLE) && CONFIG_ZMK_BLE && \
    defined(CONFIG_ZMK_RUNTIME_MACRO_DYNAMIC_CLEAR_ON_BLE_PROFILE_CHANGE) && \
    CONFIG_ZMK_RUNTIME_MACRO_DYNAMIC_CLEAR_ON_BLE_PROFILE_CHANGE
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_BLE_PROFILE_CHANGE_FLAG \
  ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_BLE_PROFILE_CHANGE
#else
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_BLE_PROFILE_CHANGE_FLAG 0U
#endif
...
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_ENDPOINT_CHANGE_FLAG \
  ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_CLEAR_ON_ENDPOINT_CHANGE
#else
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_ENDPOINT_CHANGE_FLAG 0U
#endif

#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_LIFECYCLE_FLAGS \
  (ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_FIXED_LIFECYCLE_FLAGS | \
   ...
   ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_USB_DISCONNECT_FLAG | \
   ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_BLE_PROFILE_CHANGE_FLAG | \
   ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_ENDPOINT_CHANGE_FLAG)
#define ZMK_RUNTIME_MACRO_PROTOCOL_DYNAMIC_MAX_LENGTH 512U
#define ZMK_RUNTIME_MACRO_PROTOCOL_DYNAMIC_DEFAULT_TTL_SECONDS 300U
#define ZMK_RUNTIME_MACRO_PROTOCOL_DYNAMIC_MIN_TTL_SECONDS 1U
#define ZMK_RUNTIME_MACRO_PROTOCOL_DYNAMIC_MAX_TTL_SECONDS 86400U
#define ZMK_RUNTIME_MACRO_PROTOCOL_DYNAMIC_TRANSACTION_TIMEOUT_SECONDS 30U
#define ZMK_RUNTIME_MACRO_PROTOCOL_DYNAMIC_BEGIN_FLAG_KEEP_AFTER_EXECUTE \
  (1U << 0)
#define ZMK_RUNTIME_MACRO_PROTOCOL_DYNAMIC_BEGIN_KNOWN_FLAGS \
...
enum zmk_runtime_macro_protocol_opcode {
  ...
  ZMK_RUNTIME_MACRO_PROTOCOL_OPCODE_DYNAMIC_BEGIN = 0x20,
  ZMK_RUNTIME_MACRO_PROTOCOL_OPCODE_DYNAMIC_DATA = 0x21,
  ZMK_RUNTIME_MACRO_PROTOCOL_OPCODE_DYNAMIC_CLEAR = 0x22,
  ZMK_RUNTIME_MACRO_PROTOCOL_OPCODE_CAPABILITIES = 0x23,
};
...
struct zmk_runtime_macro_protocol {
  ...
  /* Dynamic transaction identity; bytes remain owned by the RAM store. */
  bool dynamic_active;
  uint8_t dynamic_slot;
  uint8_t dynamic_request_id;
  uint16_t dynamic_total_length;
  uint16_t dynamic_received_length;
  int64_t dynamic_deadline_ms;
};
