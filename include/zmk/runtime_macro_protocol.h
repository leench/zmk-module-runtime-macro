...
#define ZMK_RUNTIME_MACRO_PROTOCOL_DYNAMIC_SLOT \
  ZMK_RUNTIME_MACRO_PROTOCOL_LIST_SLOT

#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_VERSION 1U
#define ZMK_RUNTIME_MACRO_PROTOCOL_CAPABILITY_OBJECT_COUNT 1U
...
#define ZMK_RUNTIME_MACRO_PROTOCOL_DYNAMIC_MAX_LENGTH 256U
