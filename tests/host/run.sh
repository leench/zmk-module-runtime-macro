...
test_sources="runtime_macro_slots_test runtime_macro_executor_test runtime_macro_protocol_test runtime_macro_usb_hid_test runtime_macro_auth_test runtime_macro_auth_protocol_test runtime_macro_dynamic_gate_test"
